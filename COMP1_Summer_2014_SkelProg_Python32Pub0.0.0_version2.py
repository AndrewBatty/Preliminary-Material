...
def DisplayEndOfGameMessage(Score):
  ...
  print()
  print('Do you want to add your score to the high score table? (y or n): ', end='')
...
def DisplayRecentScores(RecentScores):
  ...
  print('Recent Scores: ')
  print()
  print("{0:<8} {1:<8} {2:<6}".format("Name","Score","Date"))
  print()
  for Count in range(1, NO_OF_RECENT_SCORES + 1):
    print("{0:<8} {1:<8} {2:<6}".format(RecentScores[Count].Name, RecentScores[Count].Score,RecentScores[Count].Date))
  print()
...
def UpdateRecentScores(RecentScores, Score):
  ...
  DatePlayedString = datetime.strftime(DatePlayed,"%d/%m/%y")
  ...
  RecentScores[Count].Date = DatePlayedString
